    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Заявки на модерацию</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="card-body overflow-auto">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th><ya-tr-span data-index="338-0" data-translated="true" data-source-lang="en" data-target-lang="ru" data-value="Reason" data-translation="Причина" data-type="trSpan">Действие</ya-tr-span></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr data-widget="expandable-table" aria-expanded="false">
                              @foreach($products as $product)
                                  @if($product->moderation === null)
                                        <td>{{$product->id}}</td>
                                        ...
                                        <td>
                                            ...
                                            <form class="mb-2" action="{{route('admin.moderation.update.cancel',$product)}}" method="post" >@csrf
                                                <input name="moderation" value="1" style="display:none;" type="text"><button class="btn btn-success mr-2" >Принять</button></form>
                                            <form  action="{{route('admin.moderation.update.accept',$product)}}" method="post" >@csrf
                                                <input name="moderation" value="0" style="display:none;" type="text"><button class="btn btn-danger mr-2" >Отклонить</button></form>
                                        </td>
